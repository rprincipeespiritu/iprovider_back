...
@Table(name="ORDEN_COMPRA_DETALLE_TEXTO_REGISTRO_INFO")
public class OrdenCompraDetalleTextoRegistroInfo extends BaseDomain implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(generator = "ORDEN_COMPRA_DETALLE_TEXTO_REGISTRO_INFO_ID_SEQ", strategy = GenerationType.SEQUENCE)
	@SequenceGenerator(name = "ORDEN_COMPRA_DETALLE_TEXTO_REGISTRO_INFO_ID_SEQ", sequenceName = "ORDEN_COMPRA_DETALLE_TEXTO_REGISTRO_INFO_ID_SEQ", allocationSize = 1)
	@Column(name="ID_ORDEN_COMPRA_DETALLE_TEXTO_REGISTRO_INFO", unique=true, nullable=false)
	private Integer id;
    ...
    public String toString() {
        return "OrdenCompraDetalleTextoRegistroInfo{" +
                "id=" + id +
