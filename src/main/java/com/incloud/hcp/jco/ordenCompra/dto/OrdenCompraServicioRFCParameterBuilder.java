...
public class OrdenCompraServicioRFCParameterBuilder {

    private static final Logger logger = LoggerFactory.getLogger(OrdenCompraServicioRFCParameterBuilder.class);
    private static final String PURCH_ORG = "1000";
    private static final String STATUS = "9";
    private static final String DOC_TYPE = "ZSRV";
    private static final String COMP_CODE = "SFER";
    private static final String VALOR_X = "X";
    private static final String ITEM_CAT = "9";
    private static final String ACCTASSCAT = "F";

    private OrdenCompraServicioRFCParameterBuilder() {
    }
...
//        logger.error("OrdenCompraServicioRFCParameterBuilder Mapeando tabla input PI_POHEADER " + jCoTableInputHeader.toString());
//
//
...
//
//            jCoTableInputPoItem.setValue("SHORT_TEXT", cotizacionDetalle.getBienServicio().getDescripcion());
...
//
//        }
//        logger.error("OrdenCompraServicioRFCParameterBuilder Mapeando tabla input TO_POITEM " + jCoTableInputPoItem.toString());
//
//
//
//    }
