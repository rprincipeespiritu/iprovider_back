...
@RestController
@RequestMapping(value = "/api/actaSustentoEvaluacionProveedor")
public class ActaSustentoEvaluacionProveedorRest extends AppRest {


    @Autowired
    private ActaSustentoEvaluacionProveedorService actaSustentoEvaluacionProveedorService;
    ...
    public ResponseEntity<?> findActaSustento(@PathVariable("idActaSustento") Integer idActaSustento) {
        ...
        try{
            Object obj = this.actaSustentoEvaluacionProveedorService.findByIdActaSustento(idActaSustento);
