...
public class NumberUtils {
    ...
    public static String convertirNumeroALetras(String numero, String moneda, boolean mayusculas) {
        String literal = "";
    ...
    public static String ponerSeparadorMillares(String numero, String separador, int cantidadDecimales){
        String nuevoNumero = "";
        String caracter = "";
        int counter = 0;
        ...
        if (numero.length() > cantidadDecimales+4) {
            for (int i = numero.length()-(cantidadDecimales+2); i>=0; i--) {
                caracter = numero.substring(i, i + 1);

                if (caracter.equals(separador)) {
                    if (i <= 3) {
                        break;
                    }
                    else {
                ...
                if (counter == 3 && !numero.substring(i - 1, i).equals(separador)) {
                    nuevoNumero = numero.substring(0, i) + separador + numero.substring(i);

                    if (i <= 3)
                        return nuevoNumero;
                    else
                        return ponerSeparadorMillares(nuevoNumero, separador, cantidadDecimales);
                }
            }
        }
    ...
    public static boolean stringIsBigDecimal(String str) {
        try {
            new BigDecimal(str);
            return true;
        } catch (NumberFormatException ex) {
