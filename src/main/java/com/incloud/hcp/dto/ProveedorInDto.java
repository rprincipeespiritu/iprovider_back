...
public class ProveedorInDto {
    ...
    private Integer indDeclaracion;
    ...
    public Integer getIndDeclaracion() {
        return indDeclaracion;
    }

    public void setIndDeclaracion(Integer indDeclaracion) {
        this.indDeclaracion = indDeclaracion;
    }

    public ProveedorInDto() {
    }
