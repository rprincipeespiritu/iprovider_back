...
public class ProveedorRegistroResponse implements Serializable {

    // GS
    private String status;
    private String message;
    private String origen;
    private ProveedorRegistroBodyResponse body;
    ...
    public ProveedorRegistroBodyResponse getBody() {
        return body;
    }

    public void setBody(ProveedorRegistroBodyResponse body) {
        this.body = body;
    }
    ...
    public String toString() {
        return "ProveedorRegistroResponse{" +
                "status='" + status + '\'' +
                ", message='" + message + '\'' +
                ", origen='" + origen + '\'' +
                ", body=" + body +
