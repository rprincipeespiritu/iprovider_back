...
public class ObtenerGuiaResponse implements Serializable {

    // GS
    private String status;
    private String message;
    private String origen;
    private List<GuiaBodyResponse> body;
    ...
    public List<GuiaBodyResponse> getBody() {
        return body;
    }

    public void setBody(List<GuiaBodyResponse> body) {
        this.body = body;
    }
