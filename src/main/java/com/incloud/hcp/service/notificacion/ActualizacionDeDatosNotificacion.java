...
public class ActualizacionDeDatosNotificacion extends NotificarMail {
    ...
    private final String ASUNTO = "Actualización de datos homologación";
...
//        try {
//            mail.enviar(mailAdministrador, null, ASUNTO, content);
...
//    }
    ...
    public String enviar(MailSetting mailSetting, Proveedor proveedor, String mailAdministrador){
...
//        body = body + "Estimado/a administrador&#44;</h1>";
//        body = body + "<p style='font-family: Arial;font-size: 14px;line-height: 18px'>";
//        body = body + "El proveedor " + nombreProveedor + " con ruc: " + rucProveedor + " ha modificado sus respuestas de homologación&#44; por favor sírvase a validar su información en el siguiente enlace:<br/>";
//        body = body + "<a href=\"" + urlPortal + "\">Click aquí para revisar los datos del proveedor</a><br/><br/>";
...
//        body = body + "</html>";
        ...
        try{
            ...
            context.put("rucProveedor", rucProveedor);
            ...
            htmlMail.addTo(mailAdministrador);
            ...
            //htmlMail.send();
            respuesta = "Correo ActualizacionDeDatosNotificacion enviado";
            this.enviarCorreoSMTP(mailAdministrador, ASUNTO, content, mailSetting);
        }catch (Exception ex){
            respuesta = ex.getMessage();
            logger.error("Error al enviar el correo por ActualizacionDeDatosNotificacion del proveedor " + nombreProveedor + " con RUC " + rucProveedor, ex);
        }
        return respuesta;
    }
}
