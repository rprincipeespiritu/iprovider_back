 ...
 */
@Component
public class HomologacionAprobadaNotificacionHomExt extends NotificarMail {
    ...
    private final String TEMPLATE = "com/incloud/hcp/templates/portal/TmpHomologacionAprobadaYHomExt.html";
    private final String TEMPLATERECHAZO = "com/incloud/hcp/templates/portal/TmpHomologacionDesaprobada.html";
    private final String ASUNTO = "Homologación aprobada";
    private final String ASUNTORECHAZO = "Homologación desaprobada";
...
//    }
    ...
    public String enviar(MailSetting mailSetting, Proveedor proveedor, List<String> list) {
...
//        body = body + "Gracias por completar su información en el IProvider de Topitop.<br/>";
//        body = body + "Se confirma que a la fecha usted se encuentra Apto para participar en procesos de licitación en Topitop.<br/>";
...
//        body = body + "</html>";
        ...
        try {
            ...
            context.put("lineasComerciales", var);
            ...
            respuesta = "Correo HomologacionAprobadaNotificacion enviado";
    ...
    public String enviarRechazo(MailSetting mailSetting, Proveedor proveedor,String motivo ) {
        String contactoProveedor = proveedor.getContacto();
        String rucProveedor = proveedor.getRuc();
        String nombreProveedor = proveedor.getRazonSocial();
...
//        logger.error("El nuevo cid: " + cid);
        ...
        body = body + "Estimado/a " + contactoProveedor + "&#44;</h1>";
        body = body + "<p style='font-family: Arial;font-size: 14px;line-height: 18px'>";
        body = body + "Su Homologación a sido rechazada , por los siguientes motivos : " ;
        body = body + "<br/>"+"<b>" + motivo +"</b>"+"<br/>";
        body = body +"IProvider de JRC.<br/>";
        body = body + "<a href=\"" + urlPortal + "\">Click para ingresar a su cuenta</a><br/><br/>";
        body = body + "*Nota: En caso de presentar problemas con su inicio de sesión, copie y pegue el siguiente enlace en un nuevo navegador en modo incógnito:<br/>";
        body = body + "<a href='" + urlPortal + "'>" + urlPortal + "</a><br/>";
        body = body + "</p>";
