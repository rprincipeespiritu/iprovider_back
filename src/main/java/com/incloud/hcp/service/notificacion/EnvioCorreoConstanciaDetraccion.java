...
@Component
public class EnvioCorreoConstanciaDetraccion extends NotificarMail {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private final String LOGO = "com/incloud/hcp/templates/img/call-to-action.png"; //por arreglar

    private final String TEMPLATE = "com/incloud/hcp/templates/portal/TmpEnvioCorreoConstanciaDetraccion.html";
    ...
    public String enviar(MailSetting mailSetting, ConstanciaDetraccionProveedorDto dataProveedor) {
        Integer nroConstancia = dataProveedor.getNroConstancia();
        String asunto = "PUBLICACIÓN COMPROBANTE DE DETRACCIÓN";
        ...
        try {
            ...
            context.put("nroConstancia", nroConstancia);
            ...
            respuesta = "correo EnvioCorreoConstanciaDetraccion enviado";
            ...
            logger.error("Error al enviar el correo por por EnvioCorreoConstanciaDetraccion al proveedor " + dataProveedor.getRazonSocialProveedor() + " con la constancia de detraccion " + dataProveedor.getNroConstancia(), ex);
