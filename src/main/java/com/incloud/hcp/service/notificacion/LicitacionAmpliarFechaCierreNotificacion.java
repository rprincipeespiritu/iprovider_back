...
//    }
    ...
    public String enviar(MailSetting mailSetting, ProveedorCustom proveedor, Licitacion licitacion,
        ...
        String asunto = "Actualización de negociación nro. " + numeroLicitacion;
        String respuesta = "";
...
//        body = body + "</html>";
        ...
        try {
            ...
            htmlMail.send();
            respuesta = "Correo LicitacionAmpliarFechaCierreNotificacion enviado";
