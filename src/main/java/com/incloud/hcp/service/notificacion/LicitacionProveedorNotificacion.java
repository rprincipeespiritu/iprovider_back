...
public class LicitacionProveedorNotificacion extends NotificarMail {
    ...
    private final String TEMPLATEREENVIAR = "com/incloud/hcp/templates/portal/TmpReenviarLicitacionProveedor.html";
...
//    }
    ...
    public String enviar(MailSetting mailSetting, ProveedorCustom proveedor, Licitacion licitacion, List<LicitacionSubetapa> licitacionSubetapaList) {
...
//        String nombreUsuarioPublicacion = licitacion.getUsuarioPublicacionName();
        ...
        String stringFechaConfirmacion = DateUtils.convertDateToString("dd/MM/yyyy H:mm:ss", licitacion.getFechaInicioRecepcionOferta());
        String asunto = "Invitación a participar en negociación nro. " + licitacion.getNroLicitacionString();
        String respuesta = "";
        HtmlEmail htmlMail = new HtmlEmail();

        for(LicitacionSubetapa licSubetapa1 : licitacionSubetapaList) {

            if(licSubetapa1.getIdSubetapa().getId().equals(1)){
                stringFechaConfirmacion = licSubetapa1.getFechaCierreSubetapaString();
            }
        }
...
//        logger.error("El nuevo cid: " + cid);
        ...
        try {
            ...
            context.put("contacto", nombreProveedor);
            ...
            context.put("fechaConfirmacion", stringFechaConfirmacion);
            context.put("licitacionSubetapaList", body);
            context.put("emailUsuarioPublicacion", emailUsuarioPublicacion);
            ...
            respuesta = "Correo LicitacionProveedorNotificacion enviado";
    ...
    public void reenviar(MailSetting mailSetting, ProveedorCustom proveedor, Licitacion licitacion, String cuerpo) {
        String rucProveedor = proveedor.getRuc();
        String nombreProveedor = proveedor.getRazonSocial();
        String numeroLicitacion = licitacion.getNroLicitacionCero();
        String emailUsuarioPublicacion = licitacion.getUsuarioPublicacionEmail();
//        String stringFechaConfirmacion = DateUtils.convertDateToString("dd/MM/yyyy H:mm:ss", licitacion.getFechaCierreConfirmacionParticipacion());
        String asunto = "Licitación Nro. " + licitacion.getNroLicitacionString() + " - JRC";
...
//        body = body + "El equipo de Compras de CFG Investment – Topitop&#44; en línea con el cronograma del proceso " + numeroLicitacion + "&#44;<br/>";
...
//        body = body + "<a href=\"" + urlPortal + "\">Click aquí para ingresar a su cuenta</a><br/><br/>";
...
//        body = body + "</html>";
        ...
        try {
            ...
            context.put("urlportal", urlPortal);
            context.put("nombreLicitacion", numeroLicitacion);
            context.put("cuerpo", cuerpo);
            context.put("emailUsuarioPublicacion", emailUsuarioPublicacion);

            String content = Optional.ofNullable(TEMPLATEREENVIAR)
                    .map(url -> url + "")
                    .map(template -> {
                        int i = 0;
                        return getContentMail(context, template);
