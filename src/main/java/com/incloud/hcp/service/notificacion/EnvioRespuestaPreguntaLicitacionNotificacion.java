...
@Component
public class EnvioRespuestaPreguntaLicitacionNotificacion extends NotificarMail {
    ...
    private final String TEMPLATE = "com/incloud/hcp/templates/portal/TmpRespuestaPreguntaLicitacion.html";
...
//        try {
//            String asunto = "Respuesta Preguntas - Licitación Nro. " + licitacion.getNroLicitacionString();
...
//    }
    ...
    public String enviar(MailSetting mailSetting, Proveedor proveedor, Licitacion licitacion) {
        ...
        String asunto = "Respuesta a preguntas de negociación nro. " + numeroLicitacion;
        String respuesta = "";
...
//        body = body + "Se le informa que se han respondido preguntas a la Licitación Nro. " + numeroLicitacion + "&#44;<br/>";
//        body = body + "revisar en la Opción de Respuesta de Licitación.<br/>";
//        body = body + "En caso tenga alguna duda sírvase remitir su cotización a través del portal<br/>";
...
//        body = body + "<img src='cid:" + cid + "' align='LEFT' width='148' height='46'>";
//        body = body + "</p>";
//        body = body + "</td>";
//        body = body + "</tr>";
//        body = body + "</table>";
...
//        body = body + "</html>";
        ...
        try {
            ...
            context.put("emailUsuarioPublicacion", urlConsulta);
            ...
            respuesta = "Correo EnvioRespuestaPreguntaLicitacionNotificacion enviado";
            htmlMail.send();
            //this.enviarCorreoSMTP(proveedor.getEmail(), asunto, body,mailSetting);
        } catch (Exception ex) {
            respuesta = ex.getMessage();
            logger.error("Error al enviar el correo por EnvioRespuestaPreguntaLicitacionNotificacion al proveedor " + nombreProveedor + " con RUC " + rucProveedor + " por la licitacion " + numeroLicitacion, ex);
        }
        return respuesta;
    }
