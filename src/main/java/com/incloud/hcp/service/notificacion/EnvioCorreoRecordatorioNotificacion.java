...
@Component
public class EnvioCorreoRecordatorioNotificacion extends NotificarMail {
    ...
    private final String TEMPLATE = "com/incloud/hcp/templates/portal/TmpEnvioCorreoRecordatorio.html";
...
//        context.put("fechaCierre", fechaCierre);
//        context.put("descripcionSubEtapa", descripcionSubEtapa);
...
//        try {
//            String asunto = "Recordatorio " + descripcionSubEtapa + " - Licitación Nro. " + licitacion.getNroLicitacionString();
...
//    }
    ...
    public String enviar(MailSetting mailSetting, Proveedor proveedor, Licitacion licitacion, String fechaCierre,
                       String descripcionSubEtapa, String userRepublica, String emailRepublica) {
        ...
        String asunto = "Aviso de finalización de etapa " + descripcionSubEtapa + "de la negociación nro. " + numeroLicitacion;
        String respuesta = "";
...
//        body = body + "Se le informa que la Licitación Nro. " + numeroLicitacion + " el dia de " + fechaCierre + "<br/>";
//        body = body + "pasará a la Etapa: " + descripcionSubEtapa + "<br/>";
//        body = body + "En caso tenga alguna duda sírvase remitir su cotización a través del portal o haciendo clic en el siguiente enlace para ingresar a su cuenta:<br/>";
...
//        body = body + "</html>";
        ...
        try {
            ...
            respuesta = "correo EnvioCorreoRecordatorioNotificacion enviado";

            htmlMail.send();
            //this.enviarCorreoSMTP(proveedor.getEmail(), asunto, body,mailSetting);
        } catch (Exception ex) {
            logger.error("Error al enviar el correo por EnvioCorreoRecordatorioNotificacion al proveedor " + nombreProveedor + " con RUC " + rucProveedor + " por la licitacion " + numeroLicitacion, ex);
