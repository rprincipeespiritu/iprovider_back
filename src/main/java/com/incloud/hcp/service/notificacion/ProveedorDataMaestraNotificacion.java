...
public class ProveedorDataMaestraNotificacion extends NotificarMail {
    ...
    private final String LOGO_HEADER = "com/incloud/hcp/templates/img/jrclogo.jpg";
    ...
    private final String ASUNTOAPROBADO = "Data maestra aprobada";
    private final String ASUNTORECHAZO = "Repuesta Registro Data Maestra";
...
//    }
    ...
    public String enviar(MailSetting mailSetting, Proveedor proveedor, String estado,String motivo){
...
//        }else{
//            asunto = ASUNTORECHAZO;
//            mensaje = "Usted ha sido rechazado por el área de Data Maestra, "; //  ...por los siguientes motivos:
//            mensaje = mensaje + "por los siguientes motivos: "+"<br/>" +"<b>"+ motivo+ "</b>";
//            accion = "Ingrese nuevamente al sistema y modifique su información en 'Mis Datos',";
//        }
...
//        body = body + accion + "en el siguiente enlace: <br/>";
...
//        body = body + "</html>";
        ...
        try {
            ...
            if(estado.equals("APR")){
                ...
                asunto = ASUNTOAPROBADO;
                mensaje = "La información registrada es correcta por lo que continuará en el proceso de evaluación como proveedor.";
                accion = "y asegúrese de completar el cuestionario.";
            }else if(estado.equals("REC")){
                asunto = ASUNTORECHAZO;
                TEMPLATE_FINAL = TEMPLATERECHAZO;
                mensaje = "La información registrada en 'Mis Datos' tienen observaciones, por favor subsanar lo siguiente: "; //  ...por los siguientes motivos:
                mensaje = mensaje +"<br/>" +"<b>"+ motivo+ "</b>";
                accion = "";
            }
            ...
            //this.enviarCorreoSMTP(proveedor.getEmail(), asunto, content, mailSetting);
