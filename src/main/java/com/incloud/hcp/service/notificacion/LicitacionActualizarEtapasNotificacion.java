...
//        try {
//            String asunto = "Actualización Etapas - Licitación Nro. " + licitacion.getNroLicitacionString();
//
...
//    }
    ...
    public String  enviar(MailSetting mailSetting, Proveedor proveedor,
        ...
        String asunto = "Actualización de fechas en etapa de la negociación nro. " + numeroLicitacion;
        String respuesta = "";
...
//        body = body + "Se le informa que la Licitación Nro. " + numeroLicitacion + "<br/>";
...
//        body = body + "caso contrario sírvase hacer click en el siguiente enlace para ingresar a su cuenta:<br/>";
...
//        body = body + "</html>";
        ...
        try {
            ...
            context.put("emailUsuarioPublicacion", userRepublica);
            ...
            respuesta = "correo LicitacionActualizarEtapasNotificacion enviado ";
