 ...
 */
@Component
public class ProveedorHomologacionVencidaNotificacion extends NotificarMail {
    ...
    private final String TEMPLATE = "com/incloud/hcp/templates/portal/TmpProveedorHomologacionInternaVencida.html";
//    private final String TEMPLATERECHAZO = "com/incloud/hcp/templates/portal/TmpProveedorPotencialRechazado.html";
    private final String ASUNTO = "Homologación por vencer";
...
//        body = body + "</html>";
        ...
        try {
            ...
            htmlMail.send();
            respuesta = "Correo ProveedorHomologacionVencidaNotificacion enviado";
            //this.enviarCorreoSMTP(preRegistro.getEmail(), ASUNTO, content, mailSetting);
        } catch (Exception ex) {
            respuesta = ex.getMessage();
            logger.error("Error al enviar el correo por ProveedorHomologacionVencidaNotificacion al proveedor " + nombreProveedor + " con RUC " + rucProveedor, ex);
        }
        return respuesta;
    }
}
