...
//    @Value("${sm.portal.url}")
    ...
    public String enviar(MailSetting mailSetting, Licitacion licitacion, Proveedor proveedor, List<LicitacionProveedorPregunta> list) {
        ...
        String asunto = "Proveedor " + nombreProveedor + " (" + rucProveedor + ") envió preguntas a la negociación nro. " + numeroLicitacion;
        String respuesta = "";
...
//        logger.error("El nuevo cid: " + cid);
       ...
       /* String body = "<!DOCTYPE html>";
        ...
        body = body + "<a href=\"" + urlPortal + "\">Click aquí para ver las Preguntas</a><br/><br/>";
        ...
        try {
            ...
            respuesta = "Correo EnviarPreguntaLicitacionNotificacion enviado";
