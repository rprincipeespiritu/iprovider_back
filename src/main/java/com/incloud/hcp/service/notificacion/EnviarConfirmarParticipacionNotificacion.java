 ...
 */
@Component
public class EnviarConfirmarParticipacionNotificacion extends NotificarMail {
    ...
    private final String TEMPLATE = "com/incloud/hcp/templates/portal/TmpConfirmarParticipacion.html";
...
//        String asunto = "CONFIRMAR PARTICIPACION LICITACION Nro. " + licitacion.getNroLicitacionCero() +
...
//    }
    ...
    public String enviar(MailSetting mailSetting, Licitacion licitacion, Proveedor proveedor) {
        ...
        String asunto = "Confirmación de participación de la negociación nro. " + numeroLicitacion + " del proveedor: " + nombreProveedor + " (" + rucProveedor + ")";
...
//        body = body + "Estimado/a " + nombreUsuarioPublicacion + "&#44;</h1>";
...
//        body = body + "con Nro de RUC " + rucProveedor + " ha confirmado su Participación a la Licitación Nro. " + numeroLicitacion + "<br/>";
//        body = body + "<a href=\"" + urlPortal + "\">Click aquí para ver la Respuesta</a><br/><br/>";
...
//        body = body + "</html>";
        ...
        try {
            ...
            context.put("contacto", nombreUsuarioPublicacion);
            ...
            htmlMail.addTo(licitacion.getUsuarioPublicacionEmail());
            ...
            respuesta = "Correo EnviarConfirmarParticipacionNotificacion enviado";
            //this.enviarCorreoSMTP(licitacion.getUsuarioPublicacionEmail(), asunto, body,mailSetting);
        } catch (Exception ex) {
            respuesta = ex.getMessage();
            logger.error("Error al enviar el correo por EnviarConfirmarParticipacionNotificacion del proveedor " + nombreProveedor + " con RUC " + rucProveedor + " por la licitacion " + numeroLicitacion, ex);
        }
        return respuesta;
    }
}
