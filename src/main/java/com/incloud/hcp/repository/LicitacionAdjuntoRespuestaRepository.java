...
public interface LicitacionAdjuntoRespuestaRepository extends JpaRepository<LicitacionAdjuntoRespuesta, Integer> {
    ...
    @Modifying
    @Query("DELETE FROM LicitacionAdjuntoRespuesta p WHERE p.idLicitacion = ?1")
    void deleteAdjuntosLicitacionRespuesta(Integer idLicitacion);

    void deleteByIdLicitacion(Integer idLicitacion);
}